  ...
  const faqs = [
    {
      ...
      a: '네, 물론입니다! mans pet 펫택시는 보호자님 동승 승차가 무료(무제한 추가요금 없음)이며, 동생 반려 보조인이나 보호자님 한두 분까지 넉넉히 수용 가능한 넓은 적재 공간을 제공하오니 편안하게 승차하여 아이의 곁을 안심하고 지키실 수 있습니다.'
    },
    {
    ...
    },
    {
      ...
      a: '당일 1~2시간 이내의 급박한 이동이 필요하신 경우, 게시판 접수보다 대표 번호인 010-7644-0799 로 안심 긴급 전화를 주시면 인근에 공차 대기 중인 mans pet 소속 베테랑 구급 기사를 최우선으로 수배하여 긴박한 통원을 정성껏 도울 것입니다.'
    },
    {
