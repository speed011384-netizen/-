...
export const INITIAL_REVIEWS: Review[] = [
  {
    ...
    petType: 'dog',
    rating: 5,
    content: '평택에서 서울 대학병원까지 대형견 데리고 첫 통원이라 너무 조마조마했는데 기as 님이 정말 따뜻하고 친절하게 맞아주셨어요. 차량이 엄청 넓고 대형견 전용 쿠션 매트에 하네스 전용 안전벨트까지 단단히 채워주셔서 가는 동안 쿠키가 누워서 완전 편하게 갔네요. 친절한 운전과 배려에 너무 감사해서 병원 갈 때마다 무조건 mans pet만 이용합니다! 강추해요. 😍',
    date: '2026-06-11',
...
export const GALLERY_PHOTOS: GalleryPhoto[] = [
  ...
  },
  {
    id: 'photo-5',
    category: 'dog',
    title: '포메라니안 뽀미 유치원 등원길',
    description: '바쁜 견주님을 대신해 성실하게 등하원을 돕는 단골 뽀미',
...
export const SERVICES = [
  ...
  },
  {
    ...
    title: '미용숍 이동',
    sub: '이용샵까지 편안하게',
    desc: '예쁘게 가꾸기 위한 정기 예약 등원 및 바쁜 반려인을 대신한 안심 픽업앤드롭 서비스를 제공합니다.',
    tag: '유치원/미용 정기권',
    icon: 'Scissors',
    details: [
      '바쁜 현대 반려인들을 위한 단독 완벽 등하원 대행',
      '미용숍 전후 털 날림 걱정 없는 내부 상시 집진 및 연식 환기',
...
export const MOCK_BOT_RESPONSES: Record<string, string> = {
  '기본': '안녕하세요! mans pet❤펫택시 안심 도우미 봇입니다. 🐶🐾\n\n무엇이 궁금하신가요?\n\n1. 이용 요금 안내\n2. 예약 방법 및 준비 사항\n3. 반려동물 안전 조치\n4. 장거리 및 보호자 비동승 서비스\n\n번호나 궁금한 키워드를 입력해 주시면 빠르게 안내해 드릴게요!',
